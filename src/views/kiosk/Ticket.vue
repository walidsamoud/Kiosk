    ...
    <div id="Ticket">
        ...
        <div v-else id="ticketPrint" class="horizontal-ticket" style="text-align: center">
            <div class="ticket-logo">
                ...
                <span style="font-size: 15px;">{{selectedQueue ? selectedQueue.queue.title : ''}}</span>
            </div>
            <div class="welcome">
                <img :src="kioskConfig.photo != '' ? kioskConfig.photo : require('@/assets/images/liberrex-grayscale.png')" style="width: 80%; margin-bottom: 0.5cm"/>
            </div>
            <hr>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: left; width: 50%">
                        <qrcode-vue renderAs="svg" :value="qrCode" style="float: left;"></qrcode-vue>
                    </td>
