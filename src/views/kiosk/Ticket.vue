<template>
    <div class="services">
          ...
          <div class="col leftSide">
            <div class="container">
              ...
              <div class="row print_ticket">
                <div class="col">
                  <LbrxButton :name="$t('Ticket.PrintTicket')" size="medium" theme="light" hover="true" href="services"></LbrxButton>
                </div>
              </div>
        ...
        <div class="row bottom-btns">
            <div class="col">
                <LbrxButton :name="$t('Ticket.Return')" size="medium" theme="light" hover="true" href="services"></LbrxButton>
            </div>
            <div class="col">
